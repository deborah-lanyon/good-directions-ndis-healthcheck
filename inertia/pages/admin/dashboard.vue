<template>
  <AdminSidebarLayout page-title="Dashboard" page-subtitle="Platform overview">
    <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
      ...
      <h2 class="font-karla text-xl text-gray-500">Dashboard coming soon</h2>
      <p class="font-karla text-sm text-gray-400 mt-2">
        This page will show platform-wide metrics and quick actions.
      </p>
    </div>
  </AdminSidebarLayout>
</template>
